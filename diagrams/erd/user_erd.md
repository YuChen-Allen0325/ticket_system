...
erDiagram
    ...
    USERS ||--o{ USERS_AUDIT_LOG : creates
    USERS ||--o{ USERS_AUDIT_LOG : modifies
    USERS ||--o{ STORE_AUDIT_LOG : creates
    USERS ||--o{ STORE_AUDIT_LOG : audits
    USERS ||--o{ STORE : creates
    USERS ||--o{ PRODUCTS : creates
    USERS ||--o{ PRODUCT_AUDIT_LOG : audits
    PERMISSIONS ||--o{ USER_PERMISSION : assigned
    CHANNEL ||--o{ USERS_CHANNEL_MAPPING : maps
    STORE ||--o{ USER_STORE : assigns
    STORE ||--o{ STORE_AUDIT_LOG : audits
